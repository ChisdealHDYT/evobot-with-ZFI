...
module.exports = {
  ...
  async execute(message, args) {
    ...
    if (!zfiurl.audio && !zfiurl.audio) return message.reply("This Unsupported Zenzo Forge Items (NFI), Make sure its Song URL for SoundCloud or YouTube using `yt` & `soundcloud` metadata?");  
